  ...
  return (
    <div className="w-full h-[100vh] overflow-y-scroll border-r-2 border-gray-200 shadow-lg">
      {/* <img
          ...
          src="/logo.jpg"
        /> */}
      <h3 className="px-5 pt-8 text-[30px] flex items-center gap-1 text-3xl text-blue-600 font-bold"><TbFrame className="text-gray-200 text-7xl -mr-10 " />  Inframe <span className="text-black">Design</span>   </h3>
      <ul className="px-10 ">
        {tabs.map((item, index) => {
          return (
